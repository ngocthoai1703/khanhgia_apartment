...
@define ('_newarrival','Sản phẩm mới');
...
@define ('_tips','Lời Khuyên');
@define ('_mauvecorner','Góc của Mauve');
@define ('_cuahang','Cửa hàng');
@define ('_all','Tất cả');
@define ('_seeallarrivals','Xem tất cả sản phẩm mới');
@define ('_shopbycollection','Mua sắm theo bộ sưu tập');
@define ('_seethecollection','Xem bộ sưu tập');
@define ('_seemore','Xem thêm');
@define ('_quaylai','Quay lại');
@define ('_canhbaodiachi','Vui lòng nhập chi tiết Số Nhà, Phường(Xã), Quận(Huyện), Thành Phố(Tỉnh)');
...
@define ('_tong','Tổng');
@define ('_ourstore','Cửa hàng của chúng tôi');
//---------------- Tiện ích ----------------
@define ('_tienich','Tiện ích');
...
@define ('_text1','
và là người đầu tiên biết về những điểm đến mới nhất của chúng tôi, các sự kiện và chương trình khuyến mãi');
//---------------- Gio hàng + Thanh toán ----------------
...
@define ('_tienhanhthanhtoan','TIẾN HÀNH THANH TOÁN');
...
@define ('_tonggiohang','TỔNG GIỎ HÀNG');
...
@define ('_shippingto','Vận chuyển tới');
@define ('_bandanhgia','Bạn đánh giá là');
@define ('_danhgiaroi','Bạn đã đánh giá rồi.Vui lòng đánh giá lại sau 24h.Cảm ơn');
@define ('_chitietthanhtoan','Chi tiết thanh toán');
@define ('_chuyenkhoan','Chuyển khoản ngân hàng');
@define ('_tienmat','Thanh toán khi nhận hàng');
@define ('_tienmat1','Thanh toán bằng tiền mặt khi giao hàng');
@define ('_dathangthanhcong','Bạn đã đặt hàng thành công.<br> Chúng tôi sẽ liên hệ với bạn sớm nhất.<br>Mã đơn hàng là: ');//---------------- Đăng ký + Đăng nhập + Đổi mật khẩu ----------------
...
@define ('_lienhegia','Liên hệ');
@define ('_mausac','Màu');
@define ('_soluong','Số lượng');
@define ('_lienhekichthuoc','Liên hệ chúng tôi để được tư vấn về kích thước');
...
//---------------Instagram----------
@define ('_cuahanginstagram','Cửa hàng instagram');
@define ('_theodoiinstagram','Theo dõi Instagram của chúng tôi');
//---------------Mauveladies--------
@define ('_camhungmauve','Lấy cảm hứng từ #MauveLadies');
//----------------------------------
@define ('_shopthelook','Xem trong cửa hàng');
?>