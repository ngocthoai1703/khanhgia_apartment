...
<form name="supplier" id="validate" class="form" action="index.php?com=company&act=save" method="post" enctype="multipart/form-data">
       ...
       <?php } ?>
        ...
        <div class="formRow">
         ...
         <div class="formRow">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['fax']?>" name="fax" title="Nhập giờ mở cửa" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
    <div class="formRow none">
      <label>Tỉ giá(VNĐ)</label>
      <div class="formRight">
        <input type="text" value="<?=@$item['tigia']?>" name="tigia" title="Nhập tỉ giá" class="tipS" />
      </div>
      <div class="clear"></div>
    </div>  
    ...
    <div class="formRow">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['twitter']?>" name="twitter" title="Nhập địa chỉ instagram" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow " >
			<label>Shopee</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['google']?>" name="google" title="Nhập địa chỉ Shopee" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>	
    <div class="formRow">
			...
			<div class="formRight">
				<input type="text" value="<?=@$item['youtube']?>" name="youtube" title="Nhập địa chỉ Tripadvisor" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
    <div class="formRow ">
			<label>Youtube</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['skype']?>" name="skype" title="Nhập địa Youtube" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>	
         <div class="formRow none">
