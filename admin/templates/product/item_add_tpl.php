       ...
       <div id="info" class="tab_content">
        ...
        <div class="formRow">
         ...
         <div class="formRow">
            <label>Địa chỉ: </label>
            <div class="formRight">
                <input type="text" id="code_pro" name="giacu" value="<?=@$item['giacu']?>"  title="Nhập địa chỉ" class="tipS" />
            </div>
            <div class="clear"></div>
        </div>    
         ...
         <div class="formRow">
            <label>Giá bán: </label>
            <div class="formRight">
                <input type="text" id="price" name="gia" value="<?=@$item['gia']?>"  title="<?=number_format(@$item['gia'],0,',','.')?>" class="tipS" onkeypress="return OnlyNumber(event)" />
            </div>
            <div class="clear"></div>
        </div>
        ...
        <div class="formRow ">
            ...
            <div class="formRight">
                <input type="text" id="price" name="mausac" value="<?=@$item['mausac']?>"  title="Nhập Tiện ích sản phẩm,mỗi Tiện ích cách nhau dấu phẩy" class="tipS" style="float:left;" />
               
                <div class="note">Mỗi Tiện ích cách nhau dấu phẩy</div>
            </div>
            <div class="clear"></div>
        </div> 
...
<input data-val0="<?=$ds_photo[$i]['id']?>" data-val2="table_hinhanh" type="text" value="<?=$ds_photo[$i]['stt']?>" name="stt<?=$i?>" data-val3="stt"  class="tipS smallText update_stt" original-title="Nhập số thứ tự hình nahr" rel="<?=$ds_photo[$i]['id']?>" /> 
    ...
    <?php }?>
 	...
 	<div class="formRow">
        ...
        <div class="formRow ">
          <label>New In: <img src="./images/question-button.png" alt="Chọn loại" class="icon_que tipS" original-title="Bỏ chọn để không hiển thị danh mục này !"> </label>
         ...
         <div class="formRow none">
          <label>Best Seller : <img src="./images/question-button.png" alt="Chọn loại" class="icon_que tipS" original-title="Bỏ chọn để không hiển thị danh mục này !"> </label>
        ...
        <div class="formRow ">
          <label>Feature product : <img src="./images/question-button.png" alt="Chọn loại" class="icon_que tipS" original-title="Bỏ chọn để không hiển thị danh mục này !"> </label>
