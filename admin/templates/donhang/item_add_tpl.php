...
<form name="supplier" id="validate" class="form" action="index.php?com=order&act=save" method="post" enctype="multipart/form-data">
	<div class="widget">
        ...
        <div class="formRow">
			<label>Địa chỉ</label>
			<div class="formRight">
             <input type="text" name="diachi" title="Địa chỉ khách hàng" style="width:80% !important" readonly="readonly" id="diachi" class="tipS validate[required] read" value="<?=@$item['diachi']?>" />
			</div>
			<div class="clear"></div>
		</div>	
        ...
        <div class="formRow">
			...
			<div class="formRight">
             <input type="text" name="phiship" title="Cộng thêm phí giao hang hoặc - khuyến mãi cho khách hang(Nếu khuyến mãi khách hàng thì thêm dấu -)" style="width:80% !important"  id="phiship" class="tipS" value="<?=@$item['phiship']?>" />
			</div>
			<div class="clear"></div>
		</div>	        
    ...
    <tbody>
		...
		?>
			...
			<br>
                ...
                <br>
                Màu: <span class="hienthimau" style="background:<?= $chitietdonhang[$i]['mausac'] ?> "></span>
