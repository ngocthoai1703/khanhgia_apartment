    ...
    <thead>
      ...
      <tr>
       ...
       <td class="sortCol" width="120"><div>Mã đơn hàng<span></span></div></td>     
        ...
        <td width="120">Phí ship</td>

        <td width="120">Tổng thanh toán</td>
        ...
        <td align="center">
         ...
         <?php
       	...
       	<td>
       		 ...
       		 <?=number_format($items[$i]['phiship'],0, ',', '.')?>&nbsp;vnđ

       </td>

       <td>

       		 <?=number_format($tongtiendonhang*((100-$items[$i]['phantramgiamgia'])/100)+$items[$i]['phiship'],0, ',', '.')?>&nbsp;vnđ
