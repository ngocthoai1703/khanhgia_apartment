      ...
      <?php if($_GET['type']=='magiamgia'){ ?>
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                ...
                <input type="text" id="price" name="solangiamgia" value="<?=@$item['solangiamgia']?>"  title="Nhập số lần" class="tipS" onkeypress="return OnlyNumber(event)" />
        ...
        <label>Phần trăm giảm giá</label>
            ...
            <div class="formRight">
                ...
                <input type="text" name="phantramgiamgia" title="Nhập % giảm giá" id="price" class="tipS" value="<?=@$item['phantramgiamgia']?>" />
         ...
         <div class="formRow none">
            ...
            <div class="formRight">
                ...
                <input type="date"  name="thoihan" value="<?=@$item['thoihan']?>"  title="Nhập thời gian" class="tipS" min="<?= date('Y-m-d') ?>" />
  ...
  <div class="formRow">
      ...
      <?php } ?>  
       ...
       <div id="content_lang_<?=$key?>" class="tab_content">        
        ...
        <?php if($_GET['type']=='phiship' || $_GET['type']=='freeship'){ ?>
            ...
            <div class="formRight">
                ...
                <input type="text" name="phiship<?=$key?>" title="Nhập phí ship" id="phiship<?=$key?>" class="tipS" value="<?=@$item['phiship'.$key]?>" />
