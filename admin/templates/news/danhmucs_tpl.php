...
<div class="widget">
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
      ...
      <tr>
        ...
        <?php
          if($_GET['type']=='phiship')
          {
        ?>
          <td class="sortCol"><div>Tên phí ship<span></span></div></td>
          <td class="sortCol"><div>Phí ship<span></span></div></td>
        <?php
          } else {
        ?>
   ...
   <tr>
        ...
        ?>
             ...
             <td class="title_name_data">
                <a href="index.php?com=news&act=edit_danhmuc&id=<?=$items[$i]['id']?>&type=<?=$_REQUEST['type']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" class="tipS SC_bold"><?=$items[$i]['phiship']?></a>
            </td>
