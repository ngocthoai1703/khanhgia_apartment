...
function get_giamgia($giacu,$gia)
{
		global $phantram, $row;

		$phantram = ( ($giacu - $gia) / $giacu ) * 100;
...
function pagesListLimitadmin($url , $totalRows , $pageSize = 5, $offset = 5){
	...
	$firstLink = "<li><a href=\"{$url}\" class=\"left\"><i class='fa fa-backward'></i></a><li>";
	$lastLink="<li><a href=\"{$url}&p={$totalPages}\" class=\"right\"><i class='fa fa-forward'></i></a></li>";
